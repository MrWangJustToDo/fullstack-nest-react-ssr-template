...
export const targetRender: SafeAction = async ({
  req,
  res,
  store,
  lang,
  ...
  const cookieStore = createCookieStorageManager(
  ...
  const dynamicStylesPath = dynamicPageStylesPath(
    stateFileContent,
    dynamicPage,
  );

  const dynamicScriptsPath = dynamicPageScriptsPath(
    stateFileContent,
    dynamicPage,
  );
  ...
  const stream = renderToPipeableStream(
    <HTML
      ...
      preLoad={generatePreloadScriptElements(
        mainScripts.concat(runtimeScripts).concat(dynamicScriptsPath),
      )}
    >
